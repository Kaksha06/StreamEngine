...
const loginUser = asyncHandler(async (req, res) => {
    ...
    //when we give options httpony and secure as true it means that cookies can be modified only by server
    //otherwise by default cookies koi bhi modify kr skate hai
    const options = {
        httpOnly: true,
        secure: true
    }
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        {
            $lookup: {
                from: "subscriptions",//from subscription model in last line in db the word is converted into lowercase and plural 
                localField: "_id",
